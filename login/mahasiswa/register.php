...
<head>
    <meta charset="UTF-8">
    <title>Login mahasiswa PEMILU | BEM UNS</title>
            ...
            <div class="login">
                ...
                <div class="login__form">
                    <form method="post" action="registercek.php">
                        ...
                        <input type="submit" name="simpan" value="register" class="login__submit" />
                        <!--<button type="button" class="login__submit">Sign in</button>-->
                        <p class="login__signup">Kembali ke Web &nbsp;<a href="../../index.php">HOME</a></p>
                        <p class="login__signup">Login jika telah memiliki akun &nbsp;<a href="login.php">Login</a></p>
