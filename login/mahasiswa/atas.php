    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="." class="logo">
          ...
          <span class="logo-lg"><b>Mahasiswa </b>SEMIRA</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../gambar/mahasiswa/<?php echo $_SESSION['fotoskasis']; ?>" class="user-image" alt="<?php echo $_SESSION['userskasis']; ?>">
                  <span class="hidden-xs"><?php echo $_SESSION['namaskasis']; ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="../gambar/mahasiswa/<?php echo $_SESSION['fotoskasis']; ?>" class="img-circle" alt="<?php echo $_SESSION['userskasis']; ?>">
                    <p>
